$(function () {
    ...
    $("#fuelsurchargesgrid").jsGrid({
        ...
        fields: [
            ...
            { name: "FromPrice", title: "from price", type: "text", width: 150, align: "center", validate: "required" },
            { name: "ToPrice", title: "to price", type: "text", width: 150, align: "center", validate: "required" },
            { name: "FuelSurcharge", title: "fuelsurcharge", type: "text", width: 150, align: "center", validate: "required" },
    ...
    $("#aPrev").on("click", function () {
        if ($('#iPageNo').val() != '') {
            try {
                ...
                $("#fuelsurchargesgrid").jsGrid("openPage", page);
            } catch{ }
        }
    });
    ...
    $("#pageSizeData").on('change', function (event) {
        $("#fuelsurchargesgrid").jsGrid("option", "pageSize", this.value);
