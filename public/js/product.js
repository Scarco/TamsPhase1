$(function () {
    ...
    $("#Productgrid").jsGrid({
        ...
        fields: [
            ...
            { name: "ProductName", title: "Product Name", type: "text", width: 150, align: "center", validate: "required" },
    ...
    $("#aPrev").on("click", function () {
        if ($('#iPageNo').val() != '') {
            try {
                ...
                $("#productgrid").jsGrid("openPage", page);
            } catch{ }
        }
    });
    ...
    $("#pageSizeData").on('change', function (event) {
        $("#productgrid").jsGrid("option", "pageSize", this.value);
