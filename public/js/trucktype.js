$(function () {
    ...
    $("#trucktypegrid").jsGrid({
        ...
        noDataContent: "No trucktype(s) found!",
        ...
        fields: [
            ...
            { name: "TruckType", title: "Truck Type", type: "text", width: 150, align: "center", validate: "required" },
            { name: "Capacity", title: "Capacity", type: "text", width: 150, align: "center", validate: "required" },
            {
                name: "Units", title: "Units", type: "select", items: Unit, valueField: "Id", textField: "Name", align: "left", autosearch: true, validate: "required",
            ...
            {
                name: "Status", type: "select", title: "Status", sorting: true, items: status, valueField: "Id", textField: "Name", align: "left", autosearch: true,
    ...
    $("#aPrev").on("click", function () {
        if ($('#iPageNo').val() != '') {
            try {
                ...
                $("#trucktypegrid").jsGrid("openPage", page);
            } catch{ }
        }
    });
    ...
    $("#pageSizeData").on('change', function (event) {
        $("#trucktypegrid").jsGrid("option", "pageSize", this.value);
