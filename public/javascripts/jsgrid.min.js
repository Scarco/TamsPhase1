...
! function (a, b, c) {
    ...
    d.prototype = {
        ...
        _createNoDataRow: function () {
            ...
            return this._eachField(function () {
                a++
            }), b("<tr>").addClass(this.noDataRowClass).append(b("<td>").attr("colspan", a).append(this.renderTemplate(this.noDataContent, this)))
        },
        ...
        _validateItem: function (a, d) {
            ...
            if (this._eachField(function (g) {
                if (g.validate) {
                    ...
                    if (h !== c) {
                        var i = this._validation.validate(b.extend({
                            value: h,
                            rules: g.validate
                        }, f));
    ...
    function (a, b) {
        ...
        c.prototype = new d({
            ...
            _createTextBox: function () {
                return b("<input>").attr("type", "text").addClass('form-control form-filter input-sm').prop("readonly", !!this.readOnly)
            }
        ...
        d.prototype = new e({
            ...
            _createSelect: function () {
                ...
                return b.each(this.items, function (f, g) {
                    ...
                    j.prop("selected", e === f)
                }), a.prop("disabled", !!this.readOnly).addClass('form-control form-filter input-sm'), a
            }
    ...
    function (a, b) {
        ...
        c.prototype = new d({
            ...
            editButtonClass: "img/edit.png",
            // deleteButtonClass: "jsgrid-delete-button",
            deleteButtonClass: "img/delete.png",
            // searchButtonClass: "jsgrid-search-button",
            searchButtonClass: "img/search.png",
            //clearFilterButtonClass: "jsgrid-clear-filter-button",
            clearFilterButtonClass: "img/reset.png",
            //insertButtonClass: "jsgrid-insert-button",
            insertButtonClass: "img/add.png",
            //updateButtonClass: "jsgrid-update-button",
            updateButtonClass: "img/update.png",
            // cancelEditButtonClass: "jsgrid-cancel-edit-button",
            cancelEditButtonClass: "img/cancel.png",
